...
struct DirectX12_api final : public renderer_api {
    ...
    void start_draw_call(render_pass* pass, uint32 index) override final;
    ...
    void create_texture_2D(struct render_texture_2D*     texture, texture_creation_info_2D   create_info) override final;
    void create_texture_3D(struct render_texture_3D*     texture, texture_creation_info_3D   create_info) override final;
    void create_texture_cube(struct render_texture_cube* texture, texture_creation_info_cube create_info) override final;
